...
function getEnglishContent(id: string, title: string, subtitle: string) {
  // Simplified English content for demo
  return `# ${title}
...
## Overview
This module covers the essential knowledge and skills required for the Shofar ensemble.
...
*(Full English content will be updated soon)*`;
}

function getEnglishCheckpoints(id: string) {
  return ["Understand key concepts", "Practice basic techniques", "Review spiritual meaning"];
}

function getChineseContent(id: string, title: string, subtitle: string) {
  // Simplified Chinese content for demo
  return `# ${title}
